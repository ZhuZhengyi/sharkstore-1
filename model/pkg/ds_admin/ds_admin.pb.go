...
func (ProfileRequest_ProfileType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorDsAdmin, []int{21, 0}
}
...
type AdminRequest struct {
	...
	ProfileReq     *ProfileRequest     `protobuf:"bytes,18,opt,name=profile_req,json=profileReq" json:"profile_req,omitempty"`
}
...
func (m *AdminRequest) GetProfileReq() *ProfileRequest {
	if m != nil {
		return m.ProfileReq
	}
	return nil
...
type AdminResponse struct {
	...
	ProfileResp     *ProfileResponse     `protobuf:"bytes,18,opt,name=profile_resp,json=profileResp" json:"profile_resp,omitempty"`
}
...
func (m *AdminResponse) GetProfileResp() *ProfileResponse {
	if m != nil {
		return m.ProfileResp
	}
	return nil
}
...
type ProfileRequest struct {
	Ptype      ProfileRequest_ProfileType `protobuf:"varint,1,opt,name=ptype,proto3,enum=ds_adminpb.ProfileRequest_ProfileType" json:"ptype,omitempty"`
...
func (*ProfileRequest) Descriptor() ([]byte, []int) { return fileDescriptorDsAdmin, []int{21} }
...
func (*ProfileResponse) Descriptor() ([]byte, []int) { return fileDescriptorDsAdmin, []int{22} }
...
func init() {
	...
	proto.RegisterType((*ProfileRequest)(nil), "ds_adminpb.ProfileRequest")
	proto.RegisterType((*ProfileResponse)(nil), "ds_adminpb.ProfileResponse")
	...
	proto.RegisterEnum("ds_adminpb.ProfileRequest_ProfileType", ProfileRequest_ProfileType_name, ProfileRequest_ProfileType_value)
}
...
func (m *AdminRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProfileReq != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintDsAdmin(dAtA, i, uint64(m.ProfileReq.Size()))
		n10, err := m.ProfileReq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *AdminResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SetCfgResp != nil {
		...
		n11, err := m.SetCfgResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.GetCfgResp != nil {
		...
		n12, err := m.GetCfgResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if m.GetInfoResponse != nil {
		...
		n13, err := m.GetInfoResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
	...
	if m.ForceSplitResp != nil {
		...
		n14, err := m.ForceSplitResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
	...
	if m.CompactionResp != nil {
		...
		n15, err := m.CompactionResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.ClearQueueResp != nil {
		...
		n16, err := m.ClearQueueResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.GetPendingsResp != nil {
		...
		n17, err := m.GetPendingsResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
	...
	if m.FlushDbResp != nil {
		...
		n18, err := m.FlushDbResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	}
	if m.ProfileResp != nil {
		dAtA[i] = 0x92
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintDsAdmin(dAtA, i, uint64(m.ProfileResp.Size()))
		n19, err := m.ProfileResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *ProfileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OutputPath) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintDsAdmin(dAtA, i, uint64(len(m.OutputPath)))
		i += copy(dAtA[i:], m.OutputPath)
	}
	if m.Seconds != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintDsAdmin(dAtA, i, uint64(m.Seconds))
	}
	return i, nil
}
...
func (m *ProfileRequest) Size() (n int) {
	...
	if m.Seconds != 0 {
		n += 1 + sovDsAdmin(uint64(m.Seconds))
	}
	return n
}
...
func (m *AdminRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProfileReq", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProfileReq == nil {
				m.ProfileReq = &ProfileRequest{}
			}
			if err := m.ProfileReq.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AdminResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProfileResp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProfileResp == nil {
				m.ProfileResp = &ProfileResponse{}
			}
			if err := m.ProfileResp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorDsAdmin = []byte{
	...
	,
}
